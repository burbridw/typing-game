...
function renderSelect(arr){
    gameRootMenu.classList.add("behind")
...
function passSelect() {
    ...
    selectBtnGrid.innerHTML = ""
    selectionOpen = false
    gameRootMenu.classList.remove("behind")
...
`
    ...
    //document.querySelector(".back-button").addEventListener("click",clearToMenu)
}
